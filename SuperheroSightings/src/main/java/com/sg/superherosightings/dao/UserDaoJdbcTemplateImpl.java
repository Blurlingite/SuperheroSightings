...
//        
        // if they chose yes, make the user an admin, if no make them a user, if both (if the boolean is null) then make them an admin and a user
...
//        jdbcTemplate.update(SQL_INSERT_USER, user.getUserName(), user.getUserPassword(), user.getFirstName(), 
//                user.getLastName(), user.getEmail(), Boolean.TRUE);
