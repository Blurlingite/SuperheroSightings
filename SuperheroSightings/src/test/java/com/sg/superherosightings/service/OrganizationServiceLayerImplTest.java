 ...
 * @author vishnukdawah
 */
public class OrganizationServiceLayerImplTest {
    ...
    public OrganizationServiceLayerImplTest() {
    }
    ...
    public void setUp() {
        ...
        List<User> userList = userServiceLayerTest.getAllUsers();
            for(User u: userList){
                userServiceLayerTest.deleteUser(u.getUserName());
            }
    }
